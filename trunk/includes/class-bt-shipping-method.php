...
class BT_Shipping_Method extends WC_Shipping_Method {
    ...
    public function __construct( $instance_id = 0 ) {
        ...
        $this->method_title       = __( 'Burger Tyme Category Shipping', 'bt-shipping' );
        $this->method_description = __( 'Category-based shipping rules for Cajun Seasoning and Merchandise, plus role-based free Local Pickup.', 'bt-shipping' );
