 ...
 * BT_Shipping_Admin
 *
 * Adds a "Cajun Shipping" menu page under WooCommerce in wp-admin.
 * Lets the merchant:
...
class BT_Shipping_Admin {
    ...
    public function add_menu() {
        add_submenu_page(
            'woocommerce',
            __( 'Cajun Shipping Rules', 'bt-shipping' ),
            __( 'Cajun Shipping', 'bt-shipping' ),
            'manage_woocommerce',
            'bt-shipping-rules',
            [ $this, 'render_page' ]
        );
...
<style>
/* ===== Burger Tyme Shipping Admin Styles ===== */
:root {
    --bt-red:    #dd291e;
    --bt-yellow: #fce122;
    --bt-green:  #235937;
